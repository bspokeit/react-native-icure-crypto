...
exports.parseAsn1 = void 0;
// Although I've only seen 9 max in https certificates themselves,
// but each domain list could have up to 100
var ELOOPN = 102;
var ELOOP = "ujs Error: iterated over " +
    ELOOPN +
    "+ elements (probably a malformed file)";
// I've seen https certificates go 29 deep
var EDEEPN = 60;
var EDEEP = "ujs Error: element nested " +
    EDEEPN +
...
var CTYPES = [0x30, 0x31, 0xa0, 0xa1];
var VTYPES = [0x01, 0x02, 0x05, 0x06, 0x0c, 0x82];
var numToHex = function (d) {
    var dh = d.toString(16);
    if (dh.length % 2) {
        return "0" + dh;
    }
    return dh;
};
var bufToHex = function (u8) {
    var hex = [];
    var i, h;
    ...
    function parseChildren(eager) {
        ...
        while (iters < ELOOPN && index < 2 + asn1.length + asn1.lengthSize) {
            ...
            if (index > 2 + asn1.lengthSize + asn1.length) {
                ...
                throw new Error("Parse error: child value length (" +
                    child.length +
